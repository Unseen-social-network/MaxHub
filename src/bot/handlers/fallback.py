...
async def handle_unknown_command(
    ...
    await limiter.send_message(
        ...
        text=(
            "Не разобрал команду 🤔\n\n"
            "Я умею:\n"
            "📝 вести общий список дел — /todo\n"
            "📖 присылать слово дня — /word\n"
            "🖼 конвертировать изображения — просто пришлите картинку\n"
            "📱 открывать мини-приложение — /app\n\n"
            "Полный список команд — /help.\n\n"
            "В MAX пока нет обычного копирования — нажмите кнопку, чтобы "
            "скопировать нужную команду в буфер обмена, и отправьте её мне сами:"
        ),
